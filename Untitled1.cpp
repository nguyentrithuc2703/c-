...
int main() {
    ...
    tree.inOrder();
    cout << "=================================\n";
    cout << "T?ng s? node có trong cây: " << tree.totalNode() << endl;
    cout << "=================================\n";
    cout << "T?ng s? node lá có trong cây: " << tree.countLeafNode() << endl;
    cout << "=================================\n";
    cout << "T?ng s? node có hai cây con: " << tree.countTwoSubTreeNode() << endl;
    cout << "=================================\n";
    cout << "T?ng s? node có m?t cây con: " << tree.countOneSubTreeNode() << endl;
    cout << "=================================\n";
    cout << "T?ng s? node cành trên cây: " << tree.countBranchNode() << endl;
    cout << "=================================\n";
